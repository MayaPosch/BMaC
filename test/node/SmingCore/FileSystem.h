...
/// File open flags
enum FileOpenFlags {
	eFO_ReadOnly = 1,										  ///< Read only file
	eFO_WriteOnly = 2,										  ///< Write only file
	eFO_ReadWrite = eFO_ReadOnly | eFO_WriteOnly,			  ///< Read and write file
	eFO_CreateIfNotExist = 4,								  ///< Create new file if file does not exist
	eFO_Append = 8,											  ///< Append to file
	eFO_Truncate = 16,										  ///< Truncate file
